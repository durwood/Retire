...
namespace Retire
{
	...
	public class BudgetFactoryTests
	{
        ...
        public void CanCreateMonthlyBudget()
        {
            ...
            Assert.That(BudgetFactory.GetBudget().Expenses, Is.EqualTo(12 * 2000.0));
		}
		...
		public void CanCreateAnnualBudget()
		{
            ...
            Assert.That(BudgetFactory.GetBudget().Expenses, Is.EqualTo(300.0));
		}
		...
		public void CanCreateBiAnnualBudget()
		{
            ...
            Assert.That(BudgetFactory.GetBudget().Expenses, Is.EqualTo(2 * 400.0));
		}
		...
		public void CanCreateWeeklyBudget()
		{
			...
			Assert.That(BudgetFactory.GetBudget().Expenses, Is.EqualTo(52 * 10.0));

			BudgetFactory.CreateBudget(2017);
			BudgetFactory.CreateWeekly(BudgetType.Personal, "Dues", 10.00, period: 2);
			Assert.That(BudgetFactory.GetBudget().Expenses, Is.EqualTo(26 * 10.0));

			BudgetFactory.CreateBudget(2017);
			BudgetFactory.CreateWeekly(BudgetType.Personal, "Dues", 10.00, period: 1, start: "Jan 10, 2017");
			Assert.That(BudgetFactory.GetBudget().Expenses, Is.EqualTo(51 * 10.0));
		...
		public void CanCreateDailyBudget()
		{
			...
			var budget = BudgetFactory.GetBudget();
			Assert.That(budget.Expenses, Is.EqualTo(365 * 10.0));

            BudgetFactory.CreateBudget(2017);
            BudgetFactory.CreateDaily(BudgetType.Personal, "Food", 10.00, "Jan 2, 2017");
            Assert.That(BudgetFactory.GetBudget().Expenses, Is.EqualTo(364.0 * 10.0));
